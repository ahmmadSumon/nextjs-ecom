...
const ProductsPage = () => {
  ...
  return (
    <div className="container mx-auto p-6 py-16">
      <section className="my-12">
        <h1 className="text-3xl text-slate-700 font-bold text-center mb-8">Men's Products</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {menClothingItems.map((product) => (
            <div key={product.id} className="product-card bg-white/60 shadow-md rounded-lg p-4 hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="p-4">
                ...
                <div className="flex justify-between mt-5 gap-2 text-sm">
  ...
  <div>
    <AllCategories/>
      ...
      <section className="my-12 ">
        <h1 className="text-3xl font-bold text-center  text-slate-700 mb-8">Women's Products</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <section className="my-12">
        <h1 className="text-3xl font-bold  text-slate-700 text-center mb-8">Kids' Products</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
